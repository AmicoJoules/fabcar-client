...
return{
	get_all_cars: function(req, res){
		...
		var channel = fabric_client.newChannel('bca');
	...
	add_car: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // recordCar - requires 5 args, ID, vessel, location, timestamp,holder - ex: args: ['10', 'Hound', '-12.021, 28.012', '1504054225', 'Hansel'], 
	...
	change_owner: function(req, res){
		console.log("changing owner of car: ");
